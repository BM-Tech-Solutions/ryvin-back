...
class NotificationService:
    ...
    """
    def send_notification(self, user: User, title: str, body: str, data: Dict[str, Any] = None) -> bool:
        """
    ...
    def send_new_match_notification(self, user: User, match: Match) -> bool:
        ...
        return self.send_notification(
            user,
            "New Match",
            f"{other_user_name} might be compatible with you!",
            {
    ...
    def send_meeting_request_notification(self, user: User, meeting_request: MeetingRequest, requester_name: str) -> bool:
        """
    ...
    def send_meeting_response_notification(self, user: User, meeting_request: MeetingRequest, accepted: bool) -> bool:
        """
